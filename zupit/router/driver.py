...
from zupit.service.driver_crud import get_driver_db
...
def create_driver(driver: Driver, conn: Connection):
    db_user = get_driver_db(user.email, conn)
    ...
    db_user = create_driver_db(user, conn)
    return db_user
